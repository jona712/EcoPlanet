...
ListCanjeoMaterialesByAdmin.propTypes = {
  idUsuario: PropTypes.string.isRequired,
};

export function ListCanjeoMaterialesByAdmin({ idUsuario }) {
  //id
  ...
  useEffect(() => {
    ...
    CanjeoMaterialesService.getAllCanjeosMaterialesByAdmin(idUsuario)
      .then((response) => {
